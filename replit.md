...
## Recent Changes
- 2026-01-17: Fixed password reset functionality - added PHPMailer initialization (was using $mail object without creating it), wrapped in try-catch for error handling.
